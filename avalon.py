...
def info(msg):
	print(FG.G + '[+] INFO: ' + str(msg) + FG.W)


def timeInfo(msg):
	import datetime
	print(FG.W + str(datetime.datetime.now()) + FG.G + ' [+] INFO: ' + str(msg) + FG.W)


def subLevelTimeInfo(msg):
	import datetime
	print(FG.DG + str(datetime.datetime.now()) + ' [+] INFO: ' + str(msg) + FG.W)


def warning(msg):
	print(FG.Y + FM.BD + '[!] WARNING: ' + str(msg) + FG.W)


def error(msg):
	print(FG.R + FM.BD + '[!] ERROR: ' + str(msg) + FG.W)


def debug(msg):
	print(FG.R + FM.RDM + '[*] DBG: ' + str(msg) + FG.W)


def input(msg):
	res = input(FG.Y + FM.BD + '[?] USER: ' + msg + FG.W)
	return res
